...
/*
 * 420DW3_07278_Project DBConnectionService.php
 *
 * @author Viraj Patel
 * @since 2024-03-28
 */
...
use Viraj\Project\Exceptions\ValidationException;
    ...
    private static function readConfigFile() : array {
        try {
            ...
            try {
                ...
                throw new Exception("Database connection configuration file at [$config_file_path] is not valid JSON.",
                                    0, $json_excep);
            }
...
//     * @throws RuntimeException If there is a failure to connect to the database.
//     */
//    public static function getConnection() : PDO {
//
//        try {
//
//            if (!(self::$connection instanceof PDO)) {
//                // Establish a new PDO connection if one does not already exist.
//                self::$connection =
//                    new PDO("mysql:dbname=" . self::DB_NAME . ";host=" . $_SERVER["HTTP_HOST"], "root", "");
//
//                self::$connection->setAttribute(PDO::ATTR_ERRMODE, PDO::ATTR_ERRMODE);
//                // self::$CONNECTION->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE) sets the error reporting mode for the PDO connection to throw exceptions when errors occur, ensuring robust error handling within the application.
//            }
//
//            // Return the PDO connection.
//            return self::$connection;
//
////        } catch (\PDOException $exception) {  // without import statement
//        } catch (PDOException $exception) {
//
//            // Throw a runtime exception if there is a failure to connect to the database.
