...
/**
 * Service class for providing a PDO database connection instance.
 */
class DBConnectionService {
    ...
    /**
     * Creates or returns an existing a PDO connection to the database.
    ...
    /**
     * Creates and returns a new PDO connection to the database based on configurations
     ...
     * @throws ValidationException If any required configuration entry is missing or invalid.
     */
